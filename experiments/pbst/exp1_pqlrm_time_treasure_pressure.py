"""
PBST exp1, PQLRM: time + treasure + pressure (v2).

Writes one convergence trace per seed into
dataviz/data/pbst_exp1/pqlrm_time_treasure_pressure.csv (hypervolume + cardinality).
"""
...
def main():
    ...
    for seed in range(args.seed_start, args.seed_start + args.seed_nbr):
        env = PBSTEnv(render_mode=None, reward_sources=[rm_time, rm_treasure, rm_pressure])
